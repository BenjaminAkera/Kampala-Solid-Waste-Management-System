...
else
{
	...
	$sql = "INSERT INTO waste.collection (collection_site, dumping_site, vehicle_id, mileage, load_weight, fuel_gauge) 
	VALUES ('$collectionSite ', '$dumpingSite ', '$vh_nm', '$mileage', '$loadWeight', '$fuelGauge') ;";
